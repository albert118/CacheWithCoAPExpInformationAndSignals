...
class CacheLayer(object):
    ...
    def __init__(self, mode, max_dim=2048, cache=None):
        """
        ...
        # Note: as whatever type of cache chosen inherits the base methods of Cache,
        # we can call the original methods without any refactoring.
        self.cache = CoapCache(mode, max_dim, cache=cache)
