...
from .coapttlcache import CoapTTLCache
...
class CoapCache:
    def __init__(self, mode, max_dim, cache=None):
        """
        ...
        elif cache is (defines.CACHE_RR):      # RR Caching case.
            self.cache = CoapRRCache(mode, max_dim)

        elif cache is (defines.CACHE_TTL):     # TTL Caching case.
            self.cache = CoapTTLCache(mode, max_dim)
